    ...
    <div id="wrapper">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form enctype="multipart/form-data" method="POST" action="/tiket/{{$tiket->slug}}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nama" type="text" class="form-control{{ $errors->has('nama') ? ' is-invalid' : '' }}" name="nama" value="{{ old('nama')? old('nama') : $tiket->nama }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control{{ $errors->has('kluster') ? ' is-invalid' : '' }}"  id="kluster" type="text" name="kluster" value="{{ old('kluster')? old('kluster') : $tiket->kluster }}" required autofocus>
