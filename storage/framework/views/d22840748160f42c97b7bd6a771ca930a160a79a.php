...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
  ...
  <body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><?php echo e(__('Tiket peserta')); ?></div>
                ...
                <div class="card-body">
                    ...
                    <?php echo e(csrf_field()); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control<?php echo e($errors->has('kluster') ? ' is-invalid' : ''); ?>"  id="kluster" type="text" name="kluster" value="<?php echo e(old('kluster')); ?>" required autofocus>
...
<?php /**PATH /home/asuspc/biner4.0/resources/views/tiket/create.blade.php ENDPATH**/ ?>