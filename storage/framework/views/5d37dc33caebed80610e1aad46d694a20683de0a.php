                ...
                <div class="card-body">
                    ...
                    <?php echo e(csrf_field()); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tanggal" type="date" class="form-control<?php echo e($errors->has('tanggal') ? ' is-invalid' : ''); ?>" name="tanggal" value="<?php echo e(old('tanggal')); ?>" required autofocus>
...
<?php /**PATH /home/u5392938/biner/resources/views/berita/create.blade.php ENDPATH**/ ?>